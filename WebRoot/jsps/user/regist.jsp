...
<div id="divMain">
  ...
  <div id="divBody">
  <form action="/goodplus/regist" method="post">
    <table id="tableForm">
      <tr>
        <td class="tdText">用户名：</td>
        <td class="tdInput">
          <input class="inputClass" type="text" name="loginname" maxlength="10" id="loginname"/>
        </td>
        <td class="tdError">
      ...
      <tr>
        ...
        <td>
          <input class="inputClass" type="text" name="verifyCode" maxlength="4"  id="verifyCode"/>
        </td>
        <td>
